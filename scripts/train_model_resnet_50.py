...
def main():
    ...
    parser.add_argument('--model-path', type=str, default='models/fossil_resnet50.pt', help='Path to save model weights')
    parser.add_argument('--index-path', type=str, default='models/train_index_resnet50.pt', help='Path to save training embedding index')
    ...
    # Load a ResNet-50 with pretrained weights to get a strong starting point
    model = models.resnet50(pretrained=args.use_pre_train)
    ...
    embedder = models.resnet50(pretrained=False)
