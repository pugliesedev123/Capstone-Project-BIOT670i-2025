...
def main():
    parser = argparse.ArgumentParser(
        description="Convert all HEIC files to JPEG in the training directory and delete originals."
    )
    parser.add_argument(
        "--train-dir",
        type=str,
    ...
    if not os.path.isdir(args.train_dir):
        print(f"Error: Directory not found at {args.train_dir}")
        return

    convert_heics_to_jpegs(args.train_dir)
